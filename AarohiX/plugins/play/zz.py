...
from pyrogram.enums import ChatMembersFilter, ChatMemberStatus , ChatType, MessageMediaType
from pyrogram.types import Message, CallbackQuery, InlineKeyboardMarkup, InlineKeyboardButton, ChatPrivileges, InputMediaPhoto, ChatPermissions, Message
...
@app.on_message(filters.command(["الاوامر"], ""), group=123)
...
@app.on_callback_query(filters.regex("permissions"), group=500)
...
@app.on_message(filters.all, group=321)
